  ...
  return (
    <div className="fixed bottom-0 left-0 flex h-[70px] w-full items-center justify-center gap-4 bg-bg-one shadow-sm-blur">
      ...
      >
        ...
        <span className="label text-sm font-semibold">Accueil</span>
      </NavLink>
      ...
      >
        ...
        <span className="label text-sm font-semibold">Bars</span>
      </NavLink>
      ...
      >
        ...
        <span className="label text-sm font-semibold">Profil</span>
      </NavLink>
    </div>
  );
}
