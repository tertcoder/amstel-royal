...
function SendPoints() {
  ...
  return (
    <div className="h-screen overflow-y-auto px-4 pb-14">
      ...
      <div className={twMerge("inset-x-0 z-50 bg-bg-one/20 absolute flex items-center max-h-screen h-full justify-center duration-200 top-0 transition-opacity backdrop-blur-sm", `${sendingPoints || sending ? 'opacity-100 scale-100' : 'scale-0 opacity-0'}`)}>
      ...
      <div className={twMerge("inset-0 bg-bg-one/20 absolute flex items-center justify-center duration-200 transition-opacity backdrop-blur-sm", `${searchParam.get('confirm') === 'true' ? 'opacity-100 scale-100' : 'scale-0 opacity-0'}`)}>
        <div className="relative">
          ...
          <button className="w-12 absolute -top-1 right-0 rounded-full h-12 z-10 bg-red- border border-text-black flex items-center justify-center" onClick={() => setSearchParam("?confirm=false")}> <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM8.96963 8.96965C9.26252 8.67676 9.73739 8.67676 10.0303 8.96965L12 10.9393L13.9696 8.96967C14.2625 8.67678 14.7374 8.67678 15.0303 8.96967C15.3232 9.26256 15.3232 9.73744 15.0303 10.0303L13.0606 12L15.0303 13.9696C15.3232 14.2625 15.3232 14.7374 15.0303 15.0303C14.7374 15.3232 14.2625 15.3232 13.9696 15.0303L12 13.0607L10.0303 15.0303C9.73742 15.3232 9.26254 15.3232 8.96965 15.0303C8.67676 14.7374 8.67676 14.2625 8.96965 13.9697L10.9393 12L8.96963 10.0303C8.67673 9.73742 8.67673 9.26254 8.96963 8.96965Z" fill="#2c1e0eac"></path> </g></svg></button>
